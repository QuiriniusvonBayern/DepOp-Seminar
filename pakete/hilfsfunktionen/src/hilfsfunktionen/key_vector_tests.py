...
if __name__ == "__main__":
    # Beispiel wie du die Funktion nutzen würdest:
    
    # Single Key Evaluation
    # result = calculate_key_to_values_score(
    #     model, "key_1", df_with_keys, 
    #     topn=20, filter_keys=True, max_fetch=1000, verbose=True
    # )
    
    # Full Model Evaluation (MIT Key-Filter - empfohlen!)
    # summary = evaluate_model_key_quality(
    #     model, df_with_keys, 
    #     num_keys=10, topn=20, 
    #     filter_keys=True, max_fetch=1000, 
    #     verbose=True
    # )
    
    # Wenn viele Keys: Erhöhe max_fetch
    # summary = evaluate_model_key_quality(
    #     model, df_with_keys, 
    #     num_keys=10, topn=20, 
    #     filter_keys=True, max_fetch=2000,  # ← Höherer Wert
    #     verbose=True
    # )
    
    # Specificity Analysis
    # spec = analyze_key_specificity(model, "key_1", df_with_keys, topn=50)
    # print(f"Specificity: {spec['specificity_score']:.3f} - {spec['interpretation']}")
    
    # Compare Multiple Models (MIT Filter)
    # models = {
    #     "Model_V1": model1,
    #     "Model_V2": model2,
    #     "Model_V3": model3
