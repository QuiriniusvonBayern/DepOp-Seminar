...
class ModelGenerator():
    ...
    def create_comparison_models(self, sentences_tokenized, base_params, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_sentence_models(self, n_sentences_tokenized, base_params, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_vector_models(self, sentences_tokenized, base_params, vector_sizes, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_window_models(self, sentences_tokenized, base_params, window_sizes, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_epoch_models(self, sentences_tokenized, base_params, num_epochs, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_min_count_models(self, sentences_tokenized, base_params, min_counts, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_negative_models(self, sentences_tokenized, base_params, negatives, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_sample_models(self, sentences_tokenized, base_params, samples, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_hs_models(self, sentences_tokenized, base_params, hs_values, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_alpha_models(self, sentences_tokenized, base_params, alphas, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_seed_models(self, sentences_tokenized, base_params, seeds, base_dir=None, verbose=False):
        if verbose:
    ...
    def create_many_models(
        ...
        models["comparison"] = self.create_comparison_models(sentences_tokenized, self.base_params, base_dir, verbose)
        models["sentences"] = self.create_sentence_models(n_sentences_tokenized, self.base_params, base_dir, verbose)
        models["vector"] = self.create_vector_models(sentences_tokenized, self.base_params, vector_sizes, base_dir, verbose)
        models["windowsize"] = self.create_window_models(sentences_tokenized, self.base_params, window_sizes, base_dir, verbose)
        models["epoch"] = self.create_epoch_models(sentences_tokenized, self.base_params, num_epochs, base_dir, verbose)
        #models["min_count"] = self.create_min_count_models(sentences_tokenized, self.base_params, min_counts, base_dir, verbose)
        models["negative"] = self.create_negative_models(sentences_tokenized, self.base_params, negatives, base_dir, verbose)
        models["sample"] = self.create_sample_models(sentences_tokenized, self.base_params, samples, base_dir, verbose)
        models["hs"] = self.create_hs_models(sentences_tokenized, self.base_params, hs_values, base_dir, verbose)
        models["alpha"] = self.create_alpha_models(sentences_tokenized, self.base_params, alphas, base_dir, verbose)
        models["seed"] = self.create_seed_models(sentences_tokenized, self.base_params, seeds, base_dir, verbose)
